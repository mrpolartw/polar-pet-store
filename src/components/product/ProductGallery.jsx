...
const ProductGallery = ({ product, activeMedia, onSelectMedia }) => (
  <section className="pdp-gallery-card">
    <div className="pdp-gallery-main">
      <ImageWithFallback src={activeMedia} alt={product.name} className="pdp-gallery-image" />
    </div>
    ...
    <div className="pdp-gallery-thumbs">
      {product.gallery.map((media) => (
        ...
        >
          <ImageWithFallback src={media} alt={product.name} className="pdp-gallery-thumb-image" />
        </button>
      ))}
    </div>
  </section>
